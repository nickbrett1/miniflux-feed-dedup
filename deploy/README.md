# Deployment runbook: miniflux-feed-dedup
...
`ghcr.io/nickbrett1/miniflux-feed-dedup` on every push to
...
(`ghcr.io/nickbrett1/miniflux-feed-dedup:buildcache`) and
...
- **Package visibility** defaults to `public` (so the NAS/Watchtower can pull
  ...
  `org.opencontainers.image.source=https://github.com/nickbrett1/miniflux-feed-dedup`,
...
2. In `docker-compose.yml`, change the image to the pinned SHA:
   `image: ghcr.io/nickbrett1/miniflux-feed-dedup:<commit-sha>`
